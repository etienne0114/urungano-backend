  ...
  chapters: [
    {
      ...
      localizedNarration: {
        ...
        rw: "Incurane ni inzira y'imibiri ya buri kwezi mu mibiri ifite imbeho. Itegura umubiri gutwita umwana. Umuzingo w'incurane uba hagati y'iminsi 21 na 35, impuzandengo ni iminsi 28. Mu muzingo wose, umwenda w'imbeho — endometri — wiyongera hanyuma ugwa nta gutwita. Ugwa kw'umwenda ni imihango yawe. Amaraso asohora atagira iminsi 3 kugeza 7. Horimone — harimo estrogene, progesiteron, LH na FSH — zigenzura ingamba zose z'incurane.",
      },
      hotspots: [],
    },
    {
      ...
      localizedNarration: {
        ...
        rw: "Imbeho ni urubundo rufite ishusho y'ikinafu, ingana n'ikiganza. Iri hagati mu nda yo hasi, hagati ya bagiteri no mu mazuru. Amagi abiri — buri reri ringana n'inzugi y'umunyu — ari ku ruhande ruhande kandi atanga amagi n'horimone. Indangashuri zihuza amagi n'imbeho. Mu gihe cy'ovulation, reri rimwe rya kuri amagi risohora irindi jira. Iryo jira rinyuramo indangashuri egera imbeho. Niba indegimana ifashe iryo jira, irihomba mu nkomanzi y'imbeho hanyuma rikura ikivuzu.",
      },
    ...
    },
    {
      ...
      localizedNarration: {
        ...
        rw: "Ingingo ya mbere: Imihango — iminsi umwe kugeza itanu. Endometri igwa. Imipaka y'horimone iri mu mpera y'isanzure. Ingingo ya kabiri: Folliculaire — iminsi umwe kugeza icyenda na gatatu. FSH ittera follicules zo ku reri gukura no gusohora estrogene. Endometri yubakwa kabone. Ingingo ya gatatu: Ovulation — irengera ku munsi wa cumi na bane. Kwiyongera kwa LH guttera isohoka ry'iryo jira rinozaho. Iki ni igihe cy'ubufite imyaka bya hejuru. Ingingo ya kane: Luteal — iminsi cumi na bitanu kugeza mirongo ibiri n'umunani. Follicule yigabyuye ihabwa ikitwa corpus luteum ikasohora progesiteron. Niba nta guhurira, progesiteron igabanuka hanyuma imihango itangira kabone.",
      },
      hotspots: [],
    },
    {
      ...
      localizedNarration: {
        ...
        rw: "Ububabare bw'imihango — bwitwa dysmenorrhée — bushimangwa n'imiti yitwa prostaglandins, ikosohawe n'umwenda w'imbeho. Prostaglandins zitera inyungu z'imitsi zitera gutsindwa kw'endometri. Uburyo bwiza bwo gukumira ububabare burimo: gutesha ubushyuhe ku nda yo hasi, gufata ibuprofen cyangwa naproxen mbere y'iko kumarana k'ububabare, siporo nziza nka guhatana cyangwa yoga, no kunywa amazi ahagije. Niba ububabare buremereye bihagije guhagarika imibereho ya buri munsi cyangwa budasubira ku buryo bwo kuvura, bona umuganga.",
      },
      hotspots: [],
    },
    {
      ...
      localizedNarration: {
        ...
        rw: "Gukurikirana incurane yawe bigufasha gusobanukirwa umubiri wawe no guhanga igihe imihango izakuza. Ushobora gukurikirana ukoresheje agahinda gasanzwe, agakoro, cyangwa application yo ku telefone. Andika umunsi wa mbere w'imihango nka buri gihe, igihe imara, n'ibimenyetso byose. Mu mezi atatu kugeza atandatu, imiterere igaragara irerekana uburebure busanzwe bw'incurane yawe n'igihe cy'ubufita imyaka.",
      },
      hotspots: [],
    },
    {
      ...
      localizedNarration: {
        ...
        rw: "Ikintu kitinya: Ntubarwa koga cyangwa gukora siporo mu gihe cy'imihango. Ukuri: Siporo irashobora kugabanya ububabare bw'inyungu binyuze mu kongera umuvuduko w'amaraso. Koga birashoboka kandi birihariwe. Ikintu kitinya: Amaraso y'imihango ni amahambwe cyangwa ntashyira mu ijoro. Ukuri: Umukungugu w'imihango ni integanyo isanzwe y'amaraso, insoro z'endometri, n'imihendo.",
      },
      hotspots: [],
    },
  ],
...
const CRAMPS_FLOW: LessonSeed = {
  ...
  chapters: [
    ...
    },
    {
      ...
      localizedNarration: {
        en: 'Light flow: one pad/tampon per day. Moderate: change every 3–4 hours. Heavy: change every 1–2 hours. More than 80 mL per cycle is heavy bleeding — can cause anaemia and needs evaluation. Dark brown blood at start or end is normal older blood.',
        ...
        rw: "Umubare muto: serivite imwe ku munsi. Umubare usanzwe: guhindura saa 3–4. Umubare munini: guhindura saa 1–2. Hejuru ya 80 mL buri muzingo ni amaraso menshi — irashobora gutera anemie kandi igomba gusuzumwa. Amaraso y'ibara ry'ibibabi ku ntangiriro cyangwa ku mpera ni amaraso asanzwe mashaje.",
      },
      hotspots: [],
    },
    {
      ...
      localizedNarration: {
        en: 'Heat therapy (hot water bottle 15–20 minutes) relaxes uterine muscles. Ibuprofen or naproxen taken before pain peaks is most effective. Gentle exercise releases endorphins. Magnesium-rich foods may reduce cramping. If home remedies fail, see a doctor for hormonal options or further investigation.',
        ...
        rw: "Ubushyuhe bwo gufasha (karima y'amazi ashyuha iminota 15–20) biranyuranya imitsi y'imbeho. Ibuprofen cyangwa naproxen gafatwa mbere y'ibibazo biremereye ni byiza. Siporo nziza isohora endorphines. Ibiryo bifite magnesium birashobora kugabanya ububabare.",
      },
      hotspots: [],
    },
  ],
  questions: [
    {
      ...
      correctIndex: 1,
      explanation: 'Starting anti-inflammatory medication like ibuprofen 1–2 days before the period or at first sign of pain is most effective, as it reduces prostaglandin production before it builds up.',
    },
    {
